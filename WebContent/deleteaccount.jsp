...
<form action="<%=request.getContextPath() %>/goods/deleteaccountbyPager.htm" id="qForm" method="post">
<input type="hidden" id="pageNum" name="pageNum" value="1">
	...
	<table width="90%">
	    ...
	    <td>${e.area} </td>
	    <td>${e.goodsid} </td>
	 <td><a href="<%=request.getContextPath()%>/goods/deleteaccountbyPager.htm?idd=${e.goodsid}" >删除</a></td> 
		</tr>
		</c:forEach>
	</table>
