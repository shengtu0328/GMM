...
<div class="headBar">
	<div class="topBar">
	   <div class="comWidth">
	      ...
	      <div class="rightArea">
	                      欢迎来到G买卖<a class="collection" onclick="login();">[登录]</a><a href=""class="collection">[注册]</a><a href=""class="collection">[注销]</a><a href=""class="collection">[我的订单]</a>
	      </div>
	   </div>
	</div>
	<div class="logoBar">
