...
<!-- 飞入购物车动画-->
<link rel="stylesheet" href="${base}/res/css/fly.css">
<script type="text/javascript" src="${base}/res/js/fly.js"></script>
<!-- 商品详细js-->
<script type="text/javascript" src="${base}/res/js/goodsdetail.js"></script>
...
<div class="userPosition comWidth">
	...
	<span>&nbsp;&gt;&nbsp;</span>
	<a href="${base}/goods/search.htm?categoryId=1&pm.pageSize=12">帐号</a>
	<span>&nbsp;&gt;&nbsp;</span>
	<em>${goods.title}</em>
</div>
	...
	<div class="description clearfix">
		<div class="leftArea">
			<div class="description_imgs">
				<div class="big">
					<img src="../..${goods.image}" id="img"class="imgsize" alt="">
				</div>
		...
		<div class="rightArea">
			<div class="des_content">
				...
				<div class="dl clearfix1">
					...
					<div class="dd clearfix1"><span class="des_money">帐号</span></div>
				</div>
				<div class="dl clearfix1">
					<div class="dt">区服</div>
					...
					<div class="dl">
						...
						<form action="${base}/order/goodsGenerate.htm" id="goods">
							<div class="des_number">
								...
								<div class="des_input">
									<input type="text" id="selected" name="orderdetailList[0].goodsNums"readOnly="true"  value="1">
								</div>
								<div class="plus"></div>
							</div>
			                 ...
			                 <%--      <input type="hidden" name="orderdetailList[0].subtotal" value="${goods.price}">
				                  <input type="hidden" name="totalPrice" value="${goods.price}"> --%>
	...
	<div class="rightArea">
		<div class="des_infoContent">
			...
			<div class="info_text">
				...
				<div class="info_tit">
					<h3>[职业]</h3><h4>${goods.occupation}</h4>
				</div>
				<div class="info_tit">
					<h3>[角色等级]</h3><h4>${goods.characterLevel}</h4>
				</div>
				<div class="info_tit">
					<h3>[装备属性]</h3><h4>${goods.characterEqs}</h4>
				</div>
					<div class="info_tit">
					<h3>[复活]</h3><h4>${goods.fuhuo}</h4>
				</div>

					<div class="info_tit">
					<h3>[套装/时装]</h3><h4>${goods.dress}</h4>
				</div>
					<div class="info_tit">
					<h3>[纹章]</h3><h4>${goods.wenzhang}</h4>
				</div>
					<div class="info_tit">
					<h3>[护符]</h3><h4>${goods.hufu}</h4>
				</div>
				
					<div class="info_tit">
					<h3>[金币/点券]</h3><h4>${goods.jinbidianquan}</h4>
				</div>
				
				<div class="info_tit">
					<h3>[坐骑/宠物]</h3><h4>${goods.zuojichongwu}</h4>
				</div>
					<div class="info_tit">
					<h3>[翅膀/尾巴]</h3><h4>${goods.chibangweiba}</h4>
				</div>
					<div class="info_tit">
					<h3>[背包/仓库]</h3><h4>${goods.beibaocangku}</h4>
				</div>
					<div class="info_tit">
					<h3>[竞技场等级]</h3><h4>${goods.pkLevel}</h4>
				</div>
					<div class="info_tit">
					<h3>[满级角色数量]</h3><h4>${goods.chibangweiba}</h4>
				</div>
					<div class="info_tit">
