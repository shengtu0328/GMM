...
<link type="text/css" rel="stylesheet" href="${res}/css/button.css">
...
<div class="userPosition comWidth">
	...
	<span>&nbsp;&gt;&nbsp;</span>
	<a href="${base}/goods/search.htm?categoryId=3&pm.pageSize=12">装备</a>
	<span>&nbsp;&gt;&nbsp;</span>
	<em>MD531CH/A</em>
</div>
		...
		<div class="rightArea">
			<div class="des_content">
				...
				<div class="dl clearfix1">
					...
					<div class="dd clearfix1"><span class="des_money">装备</span></div>
				</div>
				<div class="dl clearfix1">
					<div class="dt">区服</div>
				...
				<div class="shop_buy">
										<a  href="javascript:;" class="button button-raised button-caution " onclick="buy()">立即购买</a>
	...
	<div class="rightArea">
		<div class="des_infoContent">
			...
			<div class="info_text">
				...
				<div class="info_tit">
					<h3>[装备名称]</h3><h4>${goods.equipmentName}</h4>
				</div>
				<div class="info_tit">
					<h3>[装备等级]</h3><h4>${goods.equipmentLevel}</h4>
				</div>
				<div class="info_tit">
