...
<div id="close">点击关闭</div>
    ...
    <div class="logintip" id="logintip">登录</div>
    
    
    <form action="">
        <div class="login-input-box">
            <span class="icon icon-user"></span>
            <input type="text" name="username" id="popusername" placeholder="帐号">
        </div>
        <div class="login-input-box">
            <span class="icon icon-password"></span>
            <input type="password" name="password" id="poppassword"placeholder="密码">
        </div>
    ...
    <div class="login-button-box">
        <button id="login" onclick="popLogin()">登陆</button>
    </div>
    <div class="logon-box">
        <a href="">忘记密码？</a>
        <a href="${base}/user/register.htm">注册</a>
    </div>
     </form>
</div>
<script type="text/javascript">
...
<div class="headBar">
	<div class="topBar">
	   <div class="comWidth">
	      ...
	      <div class="rightArea">
	                      欢迎来到G买卖<a class="collection"  href="javascript:;" onclick="pop()"  id="showusername"><%=request.getSession().getAttribute("username")==null?"[登录]":request.getSession().getAttribute("username")%></a>
	                      <a class="collection" href="${base}/user/register.htm">[注册]</a>
	                      <a   href="javascript:;"   onclick="logoff()" class="collection">[注销]</a>
	                      <a href="${base}/user/myGoods.htm"class="collection">[我的商品]</a>
	      </div>
	   </div>
	</div>
	<div class="logoBar">
	    <div class="comWidth">
	       ...
	       <div class="search_box fl">
                ...
                <input type="text" class="search_text" name="condition">
	    ...
	    <div class="comWidth clearfix" >
	    	<div class="topmenu fl">
			  ...
			  <li><a href="#">帐号</a>
	   		...
	   		<div class="homepage fl"><a href="${base}/goods/add.htm">我要卖</a></div>
 ...
 <div class="banner comWidth clearfix">
	...
	<div class="pic">
		<ul >
			...
			<li><a href="${base}/seckill/list.htm" target="_blank"><img src="${res}/images/ad2.jpg" ></a></li>
...
<div class="shopTit comWidth">
	...
	<a href="search.htm?categoryId=1&pm.pageSize=12" class="more">更多&gt;&gt;</a>
</div>
...
<img class="leftimage" src="${res}/images/account.png" alt="banner">		
	...
	<div class="rightArea">
		...
		<c:forEach var="goods" items="${accountList}">
			<div class="shop_item">
				<div class="shop_img">
...
<div class="shopTit comWidth">
	...
	<a href="search.htm?categoryId=2&pm.pageSize=12" class="more">更多&gt;&gt;</a>
</div>
...
<img class="leftimage" src="${res}/images/gold.png" alt="banner">		
	...
	<div class="rightArea">
		<div class="shopList_top clearfix">
			<c:forEach var="goods" items="${goldList}">
			<div class="shop_item">
				<div class="shop_img">
					<a href="detail/${goods.goodsId}.htm"><img src="${base}${goods.image}" alt=""></a>
				</div>
...
<div class="shopTit comWidth">
	...
	<a href="search.htm?categoryId=3&pm.pageSize=12" class="more">更多&gt;&gt;</a>
</div>
...
<img class="leftimage" src="${res}/images/equipment.png" alt="banner">		
	...
	<div class="rightArea">
		<div class="shopList_top clearfix">
			<c:forEach var="goods" items="${equipemntList}">
			<div class="shop_item">
				<div class="shop_img">
					<a href="detail/${goods.goodsId}.htm"><img src="${base}${goods.image}" alt=""></a>
				</div>
...
function popLogin()
{
	var popusername=$("#popusername").val();
	var poppassword=$("#poppassword").val();
	var logintip=$("#logintip");
$.ajax({
		url:"${base}/user/loginCheck.htm",
	    data:{"username":popusername,"password":poppassword},
	    success:function(msg)
		 {
	    	if(msg=="0")
	    	 {   logintip.html("用户名不存在或者密码错误")        
	    	 }
	    	else
	         {
	    	   $.get(
	    			   '${base}/user/loginSuccess.htm', 
	    			   {
	    			    ...
	    			    function(data)
	    			    {
	    	              ...
	    	              <%--     var session_value = '<%=session.getAttribute("XXXXX")%>';
	    	                  $("#showusername").text(session_value); --%>
	    	                  }
	    	                  else
...
{
	$.ajax({
		'url':'${base}/user/logoff.htm',
		'success':function(data)
	     {
			if(data=="success")
			$("#showusername").text("[登录]")
			$("#cartnum").text(0);
	     }
	}
	);
